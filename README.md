...
| SHA-256 | `87c776f008a70b05265501809e87cef5747d22096bde38cd244e74e3daffecf7` |
...
패치 파일 자체의 SHA-256은 `6a47724a4ceefbfda58bbf349ef4681aa9686eb6db2b98df4937c8b9ec40610d` 입니다.
...
- 전투 화면의 조작 안내 문구(`F2:カメラスムーズON`, `移動するポイントを選択してください`, 선회/횡전 라벨 등) — 화면에 나오지만 아직 번역 대상에 넣지 않았습니다.
- 그래픽으로 그려진 일부 일본어 중 아직 찾지 못한 것.
- 개발용 더미 문자열(`★ダミー★`)과 리소스 경로 문자열은 화면에 나오지 않아 의도적으로 제외했습니다.
